...
This repository is formatted as a monorepo.

The source code for each package is located in its `src` directory.
...
[qa]: https://github.com/flex-development/grease/discussions/new?category=q-a
